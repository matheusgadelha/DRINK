...
namespace cv{
  ...
  float Descriptor::l2Distance( PatternPoint a, PatternPoint b )
  {
	...
	Descriptor::Descriptor( int _numBits = 4, int _ringSize = 8, int _numRings = 4, int _pairs = 64, bool _allPairs = false )
	{
      ...
      int raw_pairs[] = {
        876, 240, 286, 287, 433, 160, 6, 353, 159, 473, 513, 684, 40, 567, 393, 239, 1512, 886, 527, 162, 119, 1520, 60, 712, 0, 829, 916, 312, 1399, 887, 568, 992, 557, 399, 1320, 1519, 412, 476, 1552, 482, 129, 1439, 1440, 682, 1008, 1553, 1032, 643, 1352, 92, 43, 835, 1272, 846, 1432, 1168, 359, 635, 757, 968, 795, 1088, 927, 767
       // STD SORTING
